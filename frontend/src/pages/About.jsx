    ...
    <div className="text-slate-100">
      ...
      <section className="border-y border-white/5 bg-white/[0.02] py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <Reveal delay={260}>
            <p className="mt-8 text-slate-400 leading-relaxed max-w-3xl">
              This fits squarely within what the wider Stellar ecosystem is trying to enable: real-world financial
              infrastructure for underserved populations, built with Soroban's actual programmability rather than a
              token wrapped around an otherwise ordinary app.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-24">
        <Reveal>
          <TiltPanel max={3} className="glass-strong rounded-3xl p-8 sm:p-10">
            ...
            <h2 className="mt-5 text-2xl sm:text-3xl font-semibold tracking-tight">What's next</h2>
            <p className="mt-4 text-slate-400 leading-relaxed">
              The AgroLock MVP is built: a working Soroban escrow contract, a functioning buyer/farmer/attestor web
              app, and a live Naira-in/Naira-out demo on testnet. The next step is moving from prototype to a real
              pilot — development time and testnet-to-mainnet infrastructure costs, alongside a cooperative or
              aggregator partner in Nigeria ready to run it with real farmers and buyers.
            </p>
