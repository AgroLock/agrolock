  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          <IconSparkle /> Real-world asset financing, built on Stellar &amp; Soroban
        </Link>
    ...
    <section className="max-w-5xl mx-auto px-4 sm:px-6 py-24">
      <Reveal>
        <TiltPanel max={3} className="glass-strong rounded-3xl p-8 sm:p-10 grid sm:grid-cols-[1fr_auto] gap-6 items-center">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-brand-400">Real-world impact</p>
            ...
            <p className="mt-3 text-slate-400 leading-relaxed max-w-2xl">
              AgroLock is real-world asset financing for underserved populations — built with Soroban's actual
              programmability, developed by Victor Ameh.
            </p>
          </div>
          <Link
            to="/about"
